...
function GradeInfo(){
    return(<>
        ...
        <ul className="tysu_memberChild">
            <li><button id="tysu_gradeBtn" className="tysu_gradeBtn">符合資格</button></li>
            <li className="tysu_gradetext">加入會員</li>
            <li className="tysu_gradetext">$1000以上
                <br />
                / 2次購物
            </li>
            <li className="tysu_gradetext">$1500以上<br />
                / 4次購物</li>
            <li className="tysu_gradetext">$2000以上<br />
                / 6次購物</li>
        </ul>
