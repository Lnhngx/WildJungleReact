...
function ForgotPassChange(){
    ...
    const FormChange=(e)=>{
        ...
        ? {...formError, password:'', confirmpassword:''} : {...formError,[name]:''}
    ...
    const FormInvalid=(e)=>{
        e.preventDefault()
        const updateFieldError={...formError,[e.target.name]:e.target.validationMessage}
        setFormError(updateFieldError)
    }
    ...
    const submitChangePass=async (e)=>{
        ...
        if(fdpassword==='' || fdconfirmpassword===''){
            const updateFieldError={...formError,password:'請輸入欲變更的密碼',confirmpassword:'請輸入欲變更的密碼'}
            setFormError(updateFieldError);
        }
        if(fdpassword!==fdconfirmpassword){
            const updateFieldError={...formError,password:'密碼與確認密碼需相同',confirmpassword:'密碼與確認密碼需相同'}
            setFormError(updateFieldError);
        }else{
    ...
    <form id="tysu_form" onSubmit={submitChangePass} onChange={FormChange} onInvalid={FormInvalid}>
    <table>
        <tbody>
            <tr className="tysu_tr">
                ...
                <td>
                    <input type="text" id="tysu_pass" className="tysu_input" name="password" value={password} onChange={(e)=>{
                        setPassword(e.target.value)
                    }}/>
                    <div id="tysu_passHelp">{formError.password}</div>
                </td>
            ...
            <tr className="tysu_tr tysu_last">
                ...
                <td>
                    <input type="text" id="tysu_cfPass" className="tysu_input" name="confirmpassword" value={confirmpassword} onChange={(e)=>{
                        setConfirmpassword(e.target.value)
                    }}/>
                    <div id="tysu_cfPassHelp">{formError.confirmpassword}</div>
                </td>
