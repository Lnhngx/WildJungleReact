...
function OrderInfo(){
    ...
    return(<>
            <select name="cars" id="cars" className="form-select form-select-lg mb-3 tysu_select" style={{}}>
        ...
        <table className="tysu_table">
            <thead>
                <tr className="tysu_tr tysu_orderTr">
            ...
            <tbody>
                <tr className="tysu_tr tysu_orderTr tysu_orderText">
                    <th rowSpan="0" >1</th>
                    <td rowSpan="0">
