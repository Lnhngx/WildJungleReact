...
function tour(){
    ...
    <div style={{display: 'flex',paddingTop:"5rem" ,flexWrap:"wrap"}} className="tour_Group">
        <div style={{maxWidth:"30%"}} className="tourGuide1">
            <div className="tourtextArea1" style={{color: 'white'}}>
                <h2 className="tourH2" style={{fontSize:"6rem"}}>Jungle Tour</h2>
                <p className="tourP1" style={{fontSize:"3rem"}}>園區導覽</p>
            </div>
            <div>
